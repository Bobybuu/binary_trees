...
OB  * If the value is matched in the BST, returns a pointer to the matched node.
OB  * Otherwise, returns `NULL`.

* **28. BST - Remove**
  * [114-bst_remove.c](./114-bst_remove.c): C function that removes a node from
OB  a binary search tree.
...
OB    * Removing the node with the value `n`.
...
<details>
    ...
    <ul>
    <li><a href="https://https://github.com/Bobybuu/binary_trees.git">Github</a></li>
    <li><a href="chrixclout@gmail.com">e-mail</a></li>
    </ul>
</details>
